...
<div class="col-3 side-content">
    ...
    <form method="get" class="side-item">
        ...
        <div class="row">
            ...
            <input class="side-item" id="minpreco" type="text" name="minpreco" />
        </div>
        <div class="row">
            <label class="side-item" for="minpreco">Preço maximo:</label>
            <input class="side-item" id="maxpreco" type="text" name="maxpreco" />
        </div>
        <div class="row">
